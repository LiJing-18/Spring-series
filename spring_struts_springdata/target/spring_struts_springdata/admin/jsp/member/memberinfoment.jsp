...
<body data-spy="scroll" data-target=".subnav" data-offset-top="40">
	...
	<div class="navbar">
		<div class="navbar-innert">
			...
			<a class="brand" href="#">会员管理</a> 
			<a class="brand2">这里显示了所有会员列表</a>
		</div>
	</div>
	<div class="container-fluid containerb">
		<div class="row-fluid">
			...
			<div class="span10">
				...
				<div id="flexmemberinfoment">
					<table id="memberinfoment" style="display: none;"></table>
				</div>
				<div class="line-dotted"></div>
				<!-- 提示框 -->
	...
	<script type="text/javascript" src="<%=basePath%>admin/js/other/member/memberinfoment.js"></script>

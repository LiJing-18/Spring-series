...
<body data-spy="scroll" data-target=".subnav" data-offset-top="40">
	...
	<div id="navigation" class="navbar">
		<div class="navbar-innert">
			...
			<a class="brand" href="#">分享编辑 </a>
			<a class="brand2">分享编辑 </a>
		</div>
	</div>
			...
			<div id="mainlogic" class="span10">
				...
				<div class="form-actions">			
					<div class="form-inline">
						...
						<span class="label label-important">类型(1:单张照片  2:个人主页  3:常规 )</span>
					</div>
					
					<div class="form-inline">
						<span class="label label-required">文字:</span> 
						<input type="text" id="content" name="content" style="width: 400px"/>
	...
	<script type="text/javascript" src="<%=basePath%>admin/js/other/share/shareInfo.js"></script>

...
<body data-spy="scroll" data-target=".subnav" data-offset-top="40">
	...
	<div class="navbar">
		<div class="navbar-innert">
			...
			<a class="brand" href="#">分享管理</a> 
			<a class="brand2">这里显示了所有分享信息</a>
		</div>
	</div>
...
<!-- ============================================================================================ -->
				<!-- flexpersoninfoment数据显示 -->
				<div id="flexshareinfoment">
					<table id="shareinfoment" style="display: none;"></table>
				</div>
				<div class="line-dotted"></div>
<!-- ============================================================================================ -->
